...
export default function Navbar() {
    return (
        <div className="relative">
            ...
            <header
                className="absolute shadow-md inset-x-0 z-20 md:py-4 py-2 sm:fixed sm:h-24 bg-transparent  sm:py-6 "
                style={{ background: "rgba(226 232 240)" }}
            >
                <div className="mx-auto flex h-full max-w-5xl items-center justify-between md:flex-row flex-col px-2 gap-2 lg:px-8 ">
                    <div className="flex gap-6 items-center">
                        ...
                        <a
                            href="/participants"
                            className="font-medium ml-5 text-gray-600 hover:text-gray-900"
                        >
                            Participants
                        </a>
                    </div>
