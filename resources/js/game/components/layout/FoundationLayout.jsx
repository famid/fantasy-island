    ...
    return (
        ...
        >
            <div className="relative">
                <header className="absolute inset-x-0 z-20 py-4 sm:fixed sm:h-24 bg-[#587AAA]  sm:py-6 ">
                    <div className="mx-auto flex h-full max-w-7xl items-center justify-between px-6 lg:px-8">
                        <LogoLink />

                        <a
                            href="/participants"
                            className="font-medium md:block hidden ml-5 text-gray-600 hover:text-gray-900"
                        >
                            Participants
                        </a>
            ...
            <div className="min-h-screen z-50   flex items-center mx-auto justify-between max-w-7xl">
                <div className="flex flex-col md:justify-center py-7 md:py-32 md:flex-row gap-6 p-4 top-0 left-0 right-0 bottom-0 absolute game-screen ">
                    {children}
                </div>
            </div>
        </div>
